export const RESEARCH_WORKFLOW_INSTRUCTIONS = `# Research Workflow
...
export const RESEARCHER_INSTRUCTIONS = `You are a research assistant conducting research on the user's input topic. For context, today's date is {date}.
...
export const SUBAGENT_DELEGATION_INSTRUCTIONS = `# Sub-Agent Research Coordination
